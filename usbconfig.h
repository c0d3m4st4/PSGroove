...
// Include the board specific pin configuration information.
#include "config.h"
 ...
 * end.
 */
#define USB_SET_ADDRESS_HOOK            1
/* Set to 1 to call the usbSetAddr(uchar) method when a SET_ADDRESS request
 * is received.
 */
